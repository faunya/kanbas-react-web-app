...
export default function QuizDetailsFaculty() {
    ...
    return (
        <div>
            <div className="d-flex justify-content-center">
                <a className="btn btn-secondary text-center m-1" href="#">Preview</a>
                <a className="btn btn-secondary text-center m-1" href="#"><FaPencil /> Edit</a>
            </div>
